...
<form action="/connexion/login.php" method="post" class="d-flex flex-column align-items-center py-3 gap-2">
    ...
    <a href="/connexion/register.php" class="pt-2">Pas de compte ? Inscrivez-vous</a>
</form>
<?php
