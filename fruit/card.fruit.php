...
$myFruit = getFruitCrewById($db, $_GET['id']);
...
?>
    <div class="d-flex justify-content-evenly w-75 m-auto">
        ...
        <div class="d-flex flex-column w-25">
            <a href="/personnage/myperso.php?id=<?= $myFruit['p_id'] ?> "><img src="<?= $myFruit['p_pathimg'] . str_replace(' ', '_', $myFruit['p_name']) . '.jpg' ?>" alt="<?= $myFruit['p_name'] ?>" class="w-100">
